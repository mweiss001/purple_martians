...
void mwScreen::frame_and_title(int show_players)
{
   ...
   int tc = mC.get_contrasting_color(color);


   // draw the version text centered on the bottom of the border
   al_draw_textf(mF.pr8, mC.pc[tc], mwD.SCREEN_W/2, mwD.SCREEN_H-10, ALLEGRO_ALIGN_CENTRE, "Version %s", mLoop.pm_version_string);
