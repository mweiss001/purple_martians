...
int mwSolid::is_solid(int b, int c, int type)
{
   if (b == -1) // do c only
   {
...
int mwSolid::is_solidu(int b, int c, int type)
{
   if (b == -1) // do c only
   {
...
int mwSolid::lift_check_helper(int solid_x, int solid_y, int lift_check, int type, int dir)
{
   if (lift_check)
...
int mwSolid::is_right_solid(int solid_x, int solid_y, int lift_check, int type)
{
...
// returns 1 for solid block, 32+lift_num for lift
int mwSolid::is_left_solid(int solid_x, int solid_y, int lift_check, int type)
{
...
// returns 1 for solid block, 32+lift_num for lift
int mwSolid::is_down_solid(int solid_x, int solid_y, int lift_check, int type)
{
...
// returns 1 for solid block, 32+lift_num for lift
int mwSolid::is_up_solid(int solid_x, int solid_y, int lift_check, int type)
{
...
float mwSolid::is_up_solidf(float fx, float fy, float fmove, int dir)
{
   int ix = fx;
   int iy = fy;
   int im = fmove;
...
float mwSolid::is_down_solidf(float fx, float fy, float fmove, int dir)
{
   int ix = fx;
   int iy = fy;
   int im = fmove;
...
float mwSolid::is_left_solidf(float fx, float fy, float fmove, int dir)
{
   int ix = fx;
   int iy = fy;
   int im = fmove;
...
float mwSolid::is_right_solidf(float fx, float fy, float fmove, int dir)
{
   int ix = fx;
   int iy = fy;
   int im = fmove;
